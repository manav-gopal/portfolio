  ...
  return (
    <LazyMotion features={domMax}>
      ...
      >
        ...
        <a target="_blank" href={cardData.git_url} className="text-sm px-6 border-2 border-solid rounded-3xl mt-4 py-2">{"GitHub 🔗"}</a>
      </m.li>
    </LazyMotion>
  );
};
...
const cardStyle: React.CSSProperties = {
  ...
  backgroundImage: 'radial-gradient( circle farthest-corner at 10% 20%,  rgba(100,0,0,1) 0%, rgba(4,0,4,1) 95% )',
